...
namespace INVOICING_SOFTWARE.INVOICEDataSet2TableAdapters {
...
SELECT brn, company_name, vat, street_name, city, contact_number FROM clients WHERE (brn = @brn)";
        ...
        public virtual int Fill(INVOICEDataSet2.clientsDataTable dataTable) {
        ...
        public virtual INVOICEDataSet2.clientsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            INVOICEDataSet2.clientsDataTable dataTable = new INVOICEDataSet2.clientsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(INVOICEDataSet2.clientsDataTable dataTable) {
